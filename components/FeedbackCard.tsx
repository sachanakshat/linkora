  ...
  return (
    <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden mx-auto">
      <div className="flex justify-between items-center px-6 py-4">
        ...
        <div>
          <Select >
            <SelectTrigger className="w-6 h-6 text-gray-500 dark:text-gray-200" aria-label="Options">
              <svg
            ...
            <SelectContent className="w-6 h-6 text-gray-500 dark:text-gray-200" aria-label="Options">
